...
- Rencana: [webapp transkrip](docs/planning/webapp-upload-transkrip.md) · [arah Colibri](docs/planning/colibri-direction.md) · [video downloader](docs/planning/video-downloader.md) · [tangkap audio meeting](docs/planning/meeting-capture.md) · [terjemahan](docs/planning/terjemahan.md) · [control panel](docs/planning/control-panel.md)
